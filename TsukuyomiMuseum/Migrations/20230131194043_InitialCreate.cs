        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Review = table.Column<string>(type: "varchar(600)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Responsable = table.Column<string>(type: "varchar(500)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Day = table.Column<DateTime>(type: "Date", nullable: false),
                    Quantity = table.Column<int>(type: "Int", nullable: false),
                    Supplier = table.Column<string>(type: "varchar(200)", nullable: false),
                    Total = table.Column<decimal>(type: "Decimal(6,2)", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
